...
const CurrenciesBlock: React.FunctionComponent<CurrenciesBlockBlockProps> = (props: CurrenciesBlockBlockProps) => {
            ...
            <table className="table table-striped table-bordered currencies-table">
                ...
                <tbody>
                    {props.currencies.map((currency, idx) =>
                        <CurrencyBlock currency={currency} iso4217={props.iso4217} idx={idx} key={idx}/>)
                    }
                </tbody>
            </table>
